const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2023-01-21', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.devops-engineer.com.cn' }
  ],
  ...
  HEO_INFO_CARD_URL: 'https://github.com/gitlayzer', // 个人资料底部按钮链接
